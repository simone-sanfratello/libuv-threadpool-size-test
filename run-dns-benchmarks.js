...
async function main() {
  console.log('\n╔════════════════════════════════════════════════════════════╗');
  console.log('║     UV_THREADPOOL_SIZE DNS Benchmark Comparison           ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    console.log('\n' + '='.repeat(60));
    console.log('All DNS benchmarks completed successfully!');
    console.log('='.repeat(60) + '\n');
