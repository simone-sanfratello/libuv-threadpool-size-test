...
/**
 * Main function to run all crypto benchmarks and compare results
 */
async function main() {
  console.log('\n╔════════════════════════════════════════════════════════════╗');
  console.log('║     UV_THREADPOOL_SIZE Crypto Benchmark Comparison        ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  console.log(`\nRunning 100 parallel crypto operations (pbkdf2) per benchmark...\n`);
  ...
  try {
    ...
    console.log('\n' + '='.repeat(60));
    console.log('All crypto benchmarks completed successfully!');
    console.log('='.repeat(60) + '\n');
